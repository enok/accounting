package br.com.accounting.contabilidade.business.impl;
...
import br.com.accounting.contabilidade.business.ContabilidadeBusiness;
import br.com.accounting.contabilidade.dto.ContabilidadeDTO;
import br.com.accounting.contabilidade.factory.ContabilidadeDTOFactory;
import br.com.accounting.contabilidade.factory.ContabilidadeFactory;
...
public class ContabilidadeBusinessImpl extends GenericAbstractBusiness<ContabilidadeDTO, Contabilidade> implements ContabilidadeBusiness {
    ...
    private void conferirSeGrupoCadastrado(ContabilidadeDTO dto, List<String> errosCreate) throws StoreException, ParseException {
        Grupo grupo = service.buscarGrupoPorNome(dto.grupo());
        if (grupo == null) {
