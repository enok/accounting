...
import br.com.accounting.core.ordering.OrdemSubTipoPagamentoDescricao;
...
public class SubTipoPagamentoServiceImpl extends GenericAbstractService<SubTipoPagamento> implements SubTipoPagamentoService {
    ...
    public List<SubTipoPagamento> ordenarPorDescricao(Order order, List<SubTipoPagamento> subTipoPagamentos) throws ServiceException {
        ...
        try {
            Ordem ordem = new OrdemSubTipoPagamentoDescricao();
            return ordenar(ordem, order, subTipoPagamentos);
        } catch (Exception e) {
