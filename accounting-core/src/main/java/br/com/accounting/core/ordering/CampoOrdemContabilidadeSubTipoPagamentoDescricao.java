...
public class CampoOrdemContabilidadeSubTipoPagamentoDescricao implements CampoOrdem<Contabilidade, Contabilidade> {
    private static final Logger LOG = LoggerFactory.getLogger(CampoOrdemContabilidadeSubTipoPagamentoDescricao.class);
